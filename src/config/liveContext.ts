...
export const LIVE_CONTEXT_MODULES: LiveContextModule[] = [
  ...
  { id: 'spotter-network', title: 'Spotter Network', type: 'spotters', emptyMessage: 'Enable VITE_ENABLE_SPOTTER_MAP_OVERLAYS=true for in-map spotter markers, hover details, and camera handoff.', items: [] },
