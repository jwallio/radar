...
export const LIVE_CONTEXT_MODULES: LiveContextModule[] = [
  ...
  { id: 'spotter-network', title: 'Spotter Network', type: 'spotters', emptyMessage: 'Spotter map integration planned. Enable Storm Reports for nearby activity context.', items: [] },
